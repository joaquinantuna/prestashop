...
<div class="table_block order_carrier">
<div id="opc_delivery_methods" class="opc-main-block">
{if !$opc}<h1>{l s='Shipping'}</h1>{/if}
...
{else}
	...
	{/if}
	<p class="warning" id="noCarrierWarning" {if isset($carriers) && $carriers && count($carriers)}style="display:none;"{/if}>
