...
{else}
	...
	<p>{l s='Powered by' mod='blockcms'} <a href="http://www.prestashop.com">PrestaShop</a>&trade;</p>
    <p><a href="{$base_dir}cms.php?id_cms=5"><img src="{$img_dir}payment_logo.gif" alt="image" /></a></p>
