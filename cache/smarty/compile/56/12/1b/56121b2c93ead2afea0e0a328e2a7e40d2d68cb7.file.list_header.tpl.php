<?php /* Smarty version Smarty-3.1.14, created on 2014-05-03 02:08:53
         compiled from "C:\xampp\htdocs\prestashop\admin8450\themes\default\template\controllers\backup\helpers\list\list_header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15734536487f5a7d8c7-49662805%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '56121b2c93ead2afea0e0a328e2a7e40d2d68cb7' => 
    array (
      0 => 'C:\\xampp\\htdocs\\prestashop\\admin8450\\themes\\default\\template\\controllers\\backup\\helpers\\list\\list_header.tpl',
      1 => 1390222460,
      2 => 'file',
    ),
    'd59a05482d0526813237777140f917a05866761c' => 
    array (
      0 => 'C:\\xampp\\htdocs\\prestashop\\admin8450\\themes\\default\\template\\helpers\\list\\list_header.tpl',
      1 => 1390222460,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15734536487f5a7d8c7-49662805',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_536487f6319757_52602578',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_536487f6319757_52602578')) {function content_536487f6319757_52602578($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\xampp\\htdocs\\prestashop\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
<?php }?>
	...
	<?php if (isset($_smarty_tpl->tpl_vars['backup_url']->value)&&isset($_smarty_tpl->tpl_vars['backup_weight']->value)){?>
		<fieldset>
			<legend><img src="../img/admin/AdminBackup.gif" alt="" class="icon" /> <?php echo smartyTranslate(array('s'=>'Download'),$_smarty_tpl);?>
</legend>
			<p style="font-size: 13px;">
				<a href="<?php echo $_smarty_tpl->tpl_vars['backup_url']->value;?>
"><img src="../img/admin/AdminBackup.gif" alt="" class="icon" /></a>
				<b><a href="<?php echo $_smarty_tpl->tpl_vars['backup_url']->value;?>
...
<?php echo smartyTranslate(array('s'=>'MB'),$_smarty_tpl);?>
				...
				<?php echo smartyTranslate(array('s'=>'Tip: You can also download this file over to your FTP. Backup files are located in the "admin/backups" directory.'),$_smarty_tpl);?>
</p>
		</fieldset><br /><br />
	<?php }?>

	<div class="error width1" style="float: left; margin-right: 10px;">
		<p><?php echo smartyTranslate(array('s'=>'Disclaimer before creating a new backup'),$_smarty_tpl);?>
</p>
...
" method="post" style="text-align:center;">
			<input type="submit" class="button" value="<?php echo smartyTranslate(array('s'=>'I have read the disclaimer. Please create a new backup.'),$_smarty_tpl);?>
" style="padding:10px;font-weight:bold;border:1px solid;cursor:pointer;" />
		</form>

	</div>

	<div class="warn width2" style="float: left;">
		<p><?php echo smartyTranslate(array('s'=>'How to restore a database backup in 10 easy steps:'),$_smarty_tpl);?>
</p>
...
<br /><?php echo smartyTranslate(array('s'=>'If your backup file exceeds this limit, contact your hosting provider for assistence. '),$_smarty_tpl);?>
</li>
